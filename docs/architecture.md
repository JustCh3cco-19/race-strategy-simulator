...
The foundation phase contains Pydantic models in `race_strategy/models`, YAML loading in `config.py`, and a thin CLI in `cli.py`. Domain logic must not be placed in CLI commands.
